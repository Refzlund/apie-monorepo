...
export type Continue<Body = undefined> = KitResponse<100, true, Body, 'Continue' | 'informational' | 'any'>
export type SwitchingProtocols<Body = undefined> = KitResponse<101, true, Body, 'SwitchingProtocols' | 'informational' | 'any'>
export type Processing<Body = undefined> = KitResponse<102, true, Body, 'Processing' | 'informational' | 'any'>
export type EarlyHints<Body = undefined> = KitResponse<103, true, Body, 'EarlyHints' | 'informational' | 'any'>
...
export type OK<Body = undefined> = KitResponse<200, true, Body, 'OK' | 'success' | 'any'>
...
export type MultipleChoices<Body = undefined> = KitResponse<300, true, Body, 'MultipleChoices' | 'redirect' | 'any'>
...
export type BadRequest<Body = undefined> = KitResponse<400, false, Body, 'BadRequest' | 'clientError' | 'error' | 'any'>
...
export type InternalServerError<Body = undefined> = KitResponse<500, false, Body, 'InternalServerError' | 'serverError' | 'error' | 'any'>
